...
var BuildId = "MP0biQCSdwKw6nhIm_Rx2";
var HtmlPages = ["/404", "/500"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/about", "regex": "^/about(?:/)?$", "routeKeys": {}, "namedRegex": "^/about(?:/)?$" }, { "page": "/contact", "regex": "^/contact(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact(?:/)?$" }, { "page": "/privacy-policy", "regex": "^/privacy\\-policy(?:/)?$", "routeKeys": {}, "namedRegex": "^/privacy\\-policy(?:/)?$" }, { "page": "/terms-of-service", "regex": "^/terms\\-of\\-service(?:/)?$", "routeKeys": {}, "namedRegex": "^/terms\\-of\\-service(?:/)?$" }], "dynamic": [{ "page": "/author/[slug]", "regex": "^/author/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/author/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/sitemap/[file]", "regex": "^/sitemap/([^/]+?)(?:/)?$", "routeKeys": { "nxtPfile": "nxtPfile" }, "namedRegex": "^/sitemap/(?<nxtPfile>[^/]+?)(?:/)?$" }, { "page": "/[type]", "regex": "^/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtype": "nxtPtype" }, "namedRegex": "^/(?<nxtPtype>[^/]+?)(?:/)?$" }, { "page": "/[type]/[slug]", "regex": "^/([^/]+?)/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtype": "nxtPtype", "nxtPslug": "nxtPslug" }, "namedRegex": "^/(?<nxtPtype>[^/]+?)/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/[type]/[slug]/route": "/[type]/[slug]", "/[type]/route": "/[type]", "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/about/page": "/about", "/author/[slug]/route": "/author/[slug]", "/contact/page": "/contact", "/privacy-policy/page": "/privacy-policy", "/route": "/", "/sitemap/[file]/route": "/sitemap/[file]", "/terms-of-service/page": "/terms-of-service" };
